...
module.exports = {
  ...
  mountPath: '/auto-parts',
  optionalModuleLabel: 'Auto Parts (vehicle fitment / compatibility lookup)', // richer description shown in the Optional Modules toggle list specifically
};
