...
module.exports = {
  key: 'hardware',
  label: 'Hardware / Sanitary / Construction',
  category: 'Trade Crafts & Construction',
  mountPath: '/hardware',
  optionalModuleLabel: 'Hardware / Sanitary / Construction (tool rental, condition-based deposit outcome)', // richer description shown in the Optional Modules toggle list specifically
};
