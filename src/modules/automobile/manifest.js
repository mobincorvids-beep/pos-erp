...
module.exports = {
  ...
  mountPath: '/automobile',
  optionalModuleLabel: 'Automobile Showroom (VIN sale + trade-in credit)', // richer description shown in the Optional Modules toggle list specifically
};
