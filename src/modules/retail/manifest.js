...
module.exports = {
  ...
  mountPath: '/retail',
  optionalModuleLabel: 'Retail / General (layaway — cumulative-payment-triggered auto-completion)', // richer description shown in the Optional Modules toggle list specifically
};
