...
module.exports = {
  ...
  mountPath: '/electronics',
  optionalModuleLabel: 'Electronics / Mobile (serial-tied warranty + claims)', // richer description shown in the Optional Modules toggle list specifically
};
