...
module.exports = {
  ...
  mountPath: '/toys-gifts',
  optionalModuleLabel: 'Toys & Gifts (gift registry — atomic shared quota across independent purchasers)', // richer description shown in the Optional Modules toggle list specifically
};
