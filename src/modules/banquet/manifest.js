...
module.exports = {
  ...
  mountPath: '/banquet',
  optionalModuleLabel: 'Banquet / Event Hall (per-headcount pricing, deposit forfeiture)', // richer description shown in the Optional Modules toggle list specifically
};
