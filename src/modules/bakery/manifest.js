...
module.exports = {
  ...
  mountPath: '/bakery',
  optionalModuleLabel: 'Bakery / Cafe (same-day production, automatic waste write-off)', // richer description shown in the Optional Modules toggle list specifically
};
