...
module.exports = {
  key: 'service_station',
  label: 'Service Station / Workshop',
  category: 'Automotive & Transport',
  mountPath: '/service-station',
  optionalModuleLabel: 'Service Station / Workshop (vehicle mileage-based service due)', // richer description shown in the Optional Modules toggle list specifically
};
