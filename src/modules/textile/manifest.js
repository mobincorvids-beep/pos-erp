...
module.exports = {
  ...
  mountPath: '/textile',
  optionalModuleLabel: 'Textile / Leather (continuous roll depletion, auto-remnant flagging)', // richer description shown in the Optional Modules toggle list specifically
};
