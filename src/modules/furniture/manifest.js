...
module.exports = {
  ...
  mountPath: '/furniture',
  optionalModuleLabel: 'Furniture (made-to-order, real production, on-time delivery SLA)', // richer description shown in the Optional Modules toggle list specifically
};
