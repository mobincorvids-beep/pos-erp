...
async function update(req, res) {
  const allowedFields = ['name', 'industryType', 'currency', 'ntn', 'strn', 'fbrPosId', 'fbrApiToken', 'fbrSandboxMode', 'phone', 'email', 'address', 'taxAuthorities', 'province', 'businessNature', 'parentCompanyId'];
  const patch = {};
